...
`clupa()` picks a reference spectrum (the one whose
peaks are closest to all others) and attaches it. We extract that reference now, since we need it
...
internal engine (available to power users), which accepts
