...
resource_files:
  - vignettes/Classes/metabodeconplus_workflow.svg
---
...
metabodeconplus (v1.x), new functions for aligning deconvoluted spectra were added,
...
[Figure 1: Metabodecon Workflow](#figure-1-metabodeconplus-workflow).
