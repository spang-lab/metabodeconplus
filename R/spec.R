...
#' https://spang-lab.github.io/metabodeconplus/articles/FAQ.html#file-structure ) in
#' the metabodeconplus FAQ.
#'
#' @param raw
...
#'
#' @return A `spectrum` object as described in [metabodeconplus::metabodeconplus-classes].
#'
...
read_spectrum <- function(data_path = metabodeconplus_file("bruker/sim/sim_01"),
                          file_format = "bruker",
                          expno = 10,
                          procno = 10,
                          raw = FALSE,
...
#' (deconvolution, [metabodeconplus::clupa()], [metabodeconplus::snap_to_ref()],
...
#' for metabodeconplus: `acqus`, `procs` and `1r`. However, if a spectrum is
#' simulated using [metabodeconplus::simulate_spectrum()] and stored in Bruker format using
#' [metabodeconplus::save_spectrum()], an additional file called `simpar` is created, containing
