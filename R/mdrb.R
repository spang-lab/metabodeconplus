...
#'
#' @description
#' Installs metabodeconplus's Rust backend [mdrb](https://github.com/spang-lab/mdrb)
#' from [R-Universe](https://spang-lab.r-universe.dev/mdrb).
#'
#' `r lifecycle::badge("experimental")`
#'
#' The Rust backend is entirely optional; metabodeconplus's pure-R backend is the
...
#' `>= 1.80`; check with [metabodeconplus::check_mdrb_deps()]). If automatic
