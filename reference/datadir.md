...
stores metabodeconplus's example data sets or any file within that
...
#> [1] "/tmp/RtmpvmBVpJ/metabodeconplus/data"
...
#> [1] "/tmp/RtmpvmBVpJ/metabodeconplus/data/bruker/urine"
```
