...
Returns the path to metabodeconplus's temporary session directory. This
directory equals subdirectory 'metabodeconplus' of R's temporary session
...
``` r
tmpdir()
#> [1] "/tmp/RtmpsrHUGs/metabodeconplus"
tmpdir("simulate_spectra")
#> [1] "/tmp/RtmpsrHUGs/metabodeconplus/simulate_spectra"
```
