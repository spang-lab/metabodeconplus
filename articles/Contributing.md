...
1.  Create a issue at
    [github.com/spang-lab/metabodeconplus/issues](https://github.com/spang-lab/metabodeconplus/issues)
...
3.  Create a fork of the repository at
    [github.com/spang-lab/metabodeconplus](https://github.com/spang-lab/metabodeconplus)
4.  Make your edits as described in section [Making
    Edits](#making-edits)
5.  Create a pull request at
    [github.com/spang-lab/metabodeconplus/pulls](https://github.com/spang-lab/metabodeconplus/pulls)
...
1.  Function code in folder
    [R](https://spang-lab.github.io/metabodeconplus/articles/R)
2.  Function documentation in folder
    [R](https://spang-lab.github.io/metabodeconplus/articles/R)
3.  Package documentation in folder `vignettes`
4.  Test cases in folder
    [tests](https://spang-lab.github.io/metabodeconplus/articles/tests)
5.  Dependencies in file
    [DESCRIPTION](https://spang-lab.github.io/metabodeconplus/articles/DESCRIPTION)
6.  Authors in file
    [DESCRIPTION](https://spang-lab.github.io/metabodeconplus/articles/DESCRIPTION)
...
devtools::check(
    ...
    error_on = ("warning"),
    check_dir = "../metabodeconplus-RCMDcheck",
    remote = TRUE,
    manual = TRUE,
    run_dont_test = TRUE
)
