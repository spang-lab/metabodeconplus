# Data-generation scripts for metabodeconplus package datasets.
#
...
#' [metabodeconplus::sim] dataset (which itself is derived from the Blood
#' reference dataset; see [metabodeconplus::sim]). The result is a `spectra`
...
#' spectrum picked by [metabodeconplus::align()].
make_sim2 <- function() {
    set.seed(15)
...
#' see [metabodeconplus::deconvolute()].
#'
#' @author 2024-2025 Tobias Schmidt: initial version.
#'
#' @examples
...
#' the Bruker files required by metabodeconplus (`1r`, `procs`, `acqus`) to
